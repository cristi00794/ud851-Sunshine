...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, android.support.v4.app.LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final int WEATHER_LOADER = 666;
...
//        loaderManager.restartLoader(WEATHER_LOADER, queryBundle, this);
    ...
    public Loader<String[]> onCreateLoader(int id, Bundle args) {
        return new LoaderClass(this, args);
    }
    ...
    public static class LoaderClass extends AsyncTaskLoader<String[]> {
        ...
        private String[] weatherCachedData;

        private LoaderClass(Context context, Bundle bundle) {
            super(context);
            this.bundle = bundle;
            this.mainActivityWeakReference = new WeakReference<MainActivity>((MainActivity) context);
        }
        ...
        public String[] loadInBackground() {
            ...
            try {
                ...
                String[] simpleJsonWeatherData = OpenWeatherJsonUtils
                        .getSimpleWeatherStringsFromJson(mainActivityWeakReference.get(), jsonWeatherResponse);
        ...
        protected void onStartLoading() {
            ...
            if(weatherCachedData != null){
                deliverResult(weatherCachedData);
            } else {
                forceLoad();
            }
        }
